<template>
	<view class="tui-tabbar"
		...
		:style="{ background: backgroundColor, zIndex: isFixed ? zIndex : 'auto',boxShadow:boxShadow,'border-top-right-radius':borderRadius,'border-top-left-radius':borderRadius }">
...
<script>
	...
	export default {
		...
		props: {
			...
			boxShadow: {
				type: String,
				default: "0 0 2px 2px hsla(0, 0%, 50.2%, .1)"
			},
			//弧度
			borderRadius: {
				type: String,
