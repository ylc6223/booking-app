<template>
	<view class="container">
		<tui-navigation-bar transparent :splitLine="false" @init="initNavigation" :scrollTop="scrollTop" title="" backgroundColor="#ffffff00" color="#333">
			<!-- #ifdef H5 -->
			<!-- #endif -->
		</tui-navigation-bar>
		<!-- 轮播图部分 -->
			...
			<view class="mui-card-header mui-card-media">
				...
				<view class="mui-card-content-inner">
					<view class="text-black text-sm mb-20">
						We have internationalized service standards from a Tripadvisor perspective, a common goal of Customer Service experience and a beautiful experience of
						realizing customer self-worth
					</view>
				</view>
			</view>
		</view>
		<view class="card-container pb-100">
			...
			<view class="mui-card-header mui-card-media">
				...
				<view class="mui-card-content-inner">
					<view class="text-black text-sm mb-20">Currently serving 100,000+ customers and receiving good reviews</view>
				</view>
			</view>
		</view>
		<!-- 弹窗页面 -->
...
export default {
	data() {
		return {
			banners: [
				'/static/Home/banners/10002.jpg',
				'/static/Home/banners/10003.jpg',
				'/static/Home/banners/10004.jpg',
				'/static/Home/banners/10005.jpg',
				'/static/Home/banners/10006.jpg'
			],
			navs: [
				{
					text: '',
